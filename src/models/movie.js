// Формат данных от BitFilm-Movies
export const bitFilm = {
  country:"США",
...
// Формат данных ожидаемый в базе данных приложения
export const bdMovie = {
  ...
  trailerLink: { type: String, required: true }, // url
