...
export default function AboutMe() {
  return (
    ...
    <h2 className="aboutme__title">СтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудентСтудент</h2>
      <div className="aboume__separator"></div>
      <div className="aboume__content">
        <div className="aboutme__info">
          <h3 className="aboutme__subtitle">МарсельМарсельМарсельМарсельМарсельМарсельМарсельМарсельМарсельМарсельМарсель</h3>
        ...
        <a className="aboutme__link" href="https://github.com/yamarvin01" target="blank">GitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHubGitHub</a>
        </div>
